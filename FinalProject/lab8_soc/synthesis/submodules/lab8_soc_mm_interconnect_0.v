...
module lab8_soc_mm_interconnect_0 (
		...
		output wire [5:0]  Saber_Core_SABER_Slave_address,                 //                   Saber_Core_SABER_Slave.address
		output wire        Saber_Core_SABER_Slave_write,                   //                                         .write
		output wire        Saber_Core_SABER_Slave_read,                    //                                         .read
		input  wire [31:0] Saber_Core_SABER_Slave_readdata,                //                                         .readdata
		output wire [31:0] Saber_Core_SABER_Slave_writedata,               //                                         .writedata
		output wire [3:0]  Saber_Core_SABER_Slave_byteenable,              //                                         .byteenable
		output wire        Saber_Core_SABER_Slave_chipselect,              //                                         .chipselect
	...
	wire   [31:0] saber_core_saber_slave_agent_m0_readdata;                                           // Saber_Core_SABER_Slave_translator:uav_readdata -> Saber_Core_SABER_Slave_agent:m0_readdata
	wire          saber_core_saber_slave_agent_m0_waitrequest;                                        // Saber_Core_SABER_Slave_translator:uav_waitrequest -> Saber_Core_SABER_Slave_agent:m0_waitrequest
	wire          saber_core_saber_slave_agent_m0_debugaccess;                                        // Saber_Core_SABER_Slave_agent:m0_debugaccess -> Saber_Core_SABER_Slave_translator:uav_debugaccess
	wire   [28:0] saber_core_saber_slave_agent_m0_address;                                            // Saber_Core_SABER_Slave_agent:m0_address -> Saber_Core_SABER_Slave_translator:uav_address
	wire    [3:0] saber_core_saber_slave_agent_m0_byteenable;                                         // Saber_Core_SABER_Slave_agent:m0_byteenable -> Saber_Core_SABER_Slave_translator:uav_byteenable
	wire          saber_core_saber_slave_agent_m0_read;                                               // Saber_Core_SABER_Slave_agent:m0_read -> Saber_Core_SABER_Slave_translator:uav_read
	wire          saber_core_saber_slave_agent_m0_readdatavalid;                                      // Saber_Core_SABER_Slave_translator:uav_readdatavalid -> Saber_Core_SABER_Slave_agent:m0_readdatavalid
	wire          saber_core_saber_slave_agent_m0_lock;                                               // Saber_Core_SABER_Slave_agent:m0_lock -> Saber_Core_SABER_Slave_translator:uav_lock
	wire   [31:0] saber_core_saber_slave_agent_m0_writedata;                                          // Saber_Core_SABER_Slave_agent:m0_writedata -> Saber_Core_SABER_Slave_translator:uav_writedata
	wire          saber_core_saber_slave_agent_m0_write;                                              // Saber_Core_SABER_Slave_agent:m0_write -> Saber_Core_SABER_Slave_translator:uav_write
	wire    [2:0] saber_core_saber_slave_agent_m0_burstcount;                                         // Saber_Core_SABER_Slave_agent:m0_burstcount -> Saber_Core_SABER_Slave_translator:uav_burstcount
	wire          saber_core_saber_slave_agent_rf_source_valid;                                       // Saber_Core_SABER_Slave_agent:rf_source_valid -> Saber_Core_SABER_Slave_agent_rsp_fifo:in_valid
	wire  [107:0] saber_core_saber_slave_agent_rf_source_data;                                        // Saber_Core_SABER_Slave_agent:rf_source_data -> Saber_Core_SABER_Slave_agent_rsp_fifo:in_data
	wire          saber_core_saber_slave_agent_rf_source_ready;                                       // Saber_Core_SABER_Slave_agent_rsp_fifo:in_ready -> Saber_Core_SABER_Slave_agent:rf_source_ready
	wire          saber_core_saber_slave_agent_rf_source_startofpacket;                               // Saber_Core_SABER_Slave_agent:rf_source_startofpacket -> Saber_Core_SABER_Slave_agent_rsp_fifo:in_startofpacket
	wire          saber_core_saber_slave_agent_rf_source_endofpacket;                                 // Saber_Core_SABER_Slave_agent:rf_source_endofpacket -> Saber_Core_SABER_Slave_agent_rsp_fifo:in_endofpacket
	wire          saber_core_saber_slave_agent_rsp_fifo_out_valid;                                    // Saber_Core_SABER_Slave_agent_rsp_fifo:out_valid -> Saber_Core_SABER_Slave_agent:rf_sink_valid
	wire  [107:0] saber_core_saber_slave_agent_rsp_fifo_out_data;                                     // Saber_Core_SABER_Slave_agent_rsp_fifo:out_data -> Saber_Core_SABER_Slave_agent:rf_sink_data
	wire          saber_core_saber_slave_agent_rsp_fifo_out_ready;                                    // Saber_Core_SABER_Slave_agent:rf_sink_ready -> Saber_Core_SABER_Slave_agent_rsp_fifo:out_ready
	wire          saber_core_saber_slave_agent_rsp_fifo_out_startofpacket;                            // Saber_Core_SABER_Slave_agent_rsp_fifo:out_startofpacket -> Saber_Core_SABER_Slave_agent:rf_sink_startofpacket
	wire          saber_core_saber_slave_agent_rsp_fifo_out_endofpacket;                              // Saber_Core_SABER_Slave_agent_rsp_fifo:out_endofpacket -> Saber_Core_SABER_Slave_agent:rf_sink_endofpacket
	wire          cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> Saber_Core_SABER_Slave_agent:cp_valid
	wire  [106:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> Saber_Core_SABER_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // Saber_Core_SABER_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [13:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> Saber_Core_SABER_Slave_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> Saber_Core_SABER_Slave_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> Saber_Core_SABER_Slave_agent:cp_endofpacket
	...
	wire          saber_core_saber_slave_agent_rp_valid;                                              // Saber_Core_SABER_Slave_agent:rp_valid -> router_002:sink_valid
	wire  [106:0] saber_core_saber_slave_agent_rp_data;                                               // Saber_Core_SABER_Slave_agent:rp_data -> router_002:sink_data
	wire          saber_core_saber_slave_agent_rp_ready;                                              // router_002:sink_ready -> Saber_Core_SABER_Slave_agent:rp_ready
	wire          saber_core_saber_slave_agent_rp_startofpacket;                                      // Saber_Core_SABER_Slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          saber_core_saber_slave_agent_rp_endofpacket;                                        // Saber_Core_SABER_Slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          saber_core_saber_slave_agent_rdata_fifo_src_valid;                                  // Saber_Core_SABER_Slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] saber_core_saber_slave_agent_rdata_fifo_src_data;                                   // Saber_Core_SABER_Slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          saber_core_saber_slave_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter:in_0_ready -> Saber_Core_SABER_Slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> Saber_Core_SABER_Slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> Saber_Core_SABER_Slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                      // Saber_Core_SABER_Slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> Saber_Core_SABER_Slave_agent:rdata_fifo_sink_error
	...
	) saber_core_saber_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (saber_core_saber_slave_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (saber_core_saber_slave_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (saber_core_saber_slave_agent_m0_read),           //                         .read
		.uav_write              (saber_core_saber_slave_agent_m0_write),          //                         .write
		.uav_waitrequest        (saber_core_saber_slave_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (saber_core_saber_slave_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (saber_core_saber_slave_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (saber_core_saber_slave_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (saber_core_saber_slave_agent_m0_writedata),      //                         .writedata
		.uav_lock               (saber_core_saber_slave_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (saber_core_saber_slave_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (Saber_Core_SABER_Slave_address),                 //      avalon_anti_slave_0.address
		.av_write               (Saber_Core_SABER_Slave_write),                   //                         .write
		.av_read                (Saber_Core_SABER_Slave_read),                    //                         .read
		.av_readdata            (Saber_Core_SABER_Slave_readdata),                //                         .readdata
		.av_writedata           (Saber_Core_SABER_Slave_writedata),               //                         .writedata
		.av_byteenable          (Saber_Core_SABER_Slave_byteenable),              //                         .byteenable
		.av_chipselect          (Saber_Core_SABER_Slave_chipselect),              //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) saber_core_saber_slave_agent (
		.clk                     (clk_0_clk_clk),                                           //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),          //       clk_reset.reset
		.m0_address              (saber_core_saber_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (saber_core_saber_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (saber_core_saber_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (saber_core_saber_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (saber_core_saber_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (saber_core_saber_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (saber_core_saber_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (saber_core_saber_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (saber_core_saber_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (saber_core_saber_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (saber_core_saber_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (saber_core_saber_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (saber_core_saber_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (saber_core_saber_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (saber_core_saber_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (saber_core_saber_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (saber_core_saber_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (saber_core_saber_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (saber_core_saber_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (saber_core_saber_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (saber_core_saber_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (saber_core_saber_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (saber_core_saber_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (saber_core_saber_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (saber_core_saber_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (saber_core_saber_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                           //                .error
		.rdata_fifo_src_ready    (saber_core_saber_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (saber_core_saber_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (saber_core_saber_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) saber_core_saber_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                           //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (saber_core_saber_slave_agent_rf_source_data),             //        in.data
		.in_valid          (saber_core_saber_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (saber_core_saber_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (saber_core_saber_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (saber_core_saber_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (saber_core_saber_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (saber_core_saber_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (saber_core_saber_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (saber_core_saber_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (saber_core_saber_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	lab8_soc_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (saber_core_saber_slave_agent_rp_ready),          //      sink.ready
		.sink_valid         (saber_core_saber_slave_agent_rp_valid),          //          .valid
		.sink_data          (saber_core_saber_slave_agent_rp_data),           //          .data
		.sink_startofpacket (saber_core_saber_slave_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (saber_core_saber_slave_agent_rp_endofpacket),    //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (saber_core_saber_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (saber_core_saber_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (saber_core_saber_slave_agent_rdata_fifo_src_ready), //         .ready
